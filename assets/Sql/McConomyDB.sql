...
START TRANSACTION;
USE `MyConomy`;
INSERT INTO `MyConomy`.`Transaction` (`TransactionId`, `TransactionAmount`, `TransactionDate`, `TransactionTypeId`, `BalanceId`, `CalenderEventId`) VALUES (DEFAULT, 50, '2023-04-15', 4, 1, 1);
